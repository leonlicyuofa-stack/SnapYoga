...
export const allCollectibles: Collectible[] = [
    { 
      ...
      imageUrl: '/images/collectible_Yoga Matt.png',
      rarity: 'Common',
    ...
    { 
      ...
      imageUrl: '/images/collectible_Yoga_Block.png',
      rarity: 'Common',
    ...
    { 
      ...
      imageUrl: '/images/collectible_Yoga_Strap.png',
      rarity: 'Uncommon',
    ...
    { 
      ...
      imageUrl: '/images/collectible_Meditation Cushion.png',
      rarity: 'Uncommon',
    ...
    { 
      ...
      color: '#D4AF37', // Gold
      imageUrl: '/images/collectible_Yoga_Wheel.png',
      rarity: 'Epic',
    ...
    { 
      ...
      imageUrl: '/images/collectible_Yoga_Towels.png',
      rarity: 'Rare',
    ...
    },
    {
      ...
      color: '#FFC0CB', // Pink
      imageUrl: '/images/collectible_Yoga Bottle.png',
      rarity: 'Rare',
    ...
    },
    {
      ...
      color: '#FFDAB9', // Peach
      imageUrl: '/images/collectible_Yoga_Grip_Socks.png',
      rarity: 'Uncommon',
