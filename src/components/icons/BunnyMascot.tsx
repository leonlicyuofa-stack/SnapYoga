  ...
  return (
    <svg width="150" height="150" viewBox="0 0 150 150" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g transform="translate(10, 10)">
        ...
        {/* Face */}
        <ellipse cx="70" cy="72" rx="3" ry="4" fill="#FFFFFF" />
        <ellipse cx="80" cy="72" rx="3" ry="4" fill="#FFFFFF" />
        <path d="M 73,78 Q 75,81 77,78" stroke="#FFFFFF" fill="none" strokeWidth="1.5" strokeLinecap="round"/>
