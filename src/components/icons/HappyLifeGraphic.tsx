    ...
    <svg width="300" height="120" viewBox="0 0 320 120" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g fontFamily="sans-serif" fontSize="14" fontWeight="bold" textAnchor="middle">
        ...
        <g transform="translate(50, 50)">
          ...
          <path d="M0,0 L-12,35 L12,35 Z" fill="#B3B792" stroke="black" strokeWidth="1.5" strokeLinejoin="round" strokeLinecap="round" />
          <path d="M-10,0 C-20,10 -15,25 -10,35" fill="none" stroke="black" strokeWidth="1.5" strokeLinecap="round" />
          <path d="M10,0 C20,10 15,25 10,35" fill="none" stroke="black" strokeWidth="1.5" strokeLinecap="round" />
          <path d="M-5,-18 L-2,-20 L-5,-22" stroke="black" strokeWidth="1.5" strokeLinecap="round" />
          <path d="M5,-18 L2,-20 L5,-22" stroke="black" strokeWidth="1.5" strokeLinecap="round" />
          <path d="M-5,-12 Q0,-8 5,-12" fill="none" stroke="black" strokeWidth="1.5" />
        </g>
