    ...
    <svg width="300" height="120" viewBox="0 0 320 120" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g fontFamily="sans-serif" fontSize="14" fontWeight="bold" textAnchor="middle">
        ...
        <g transform="translate(50, 50)">
          <circle cx="0" cy="-15" r="15" fill="#B3B792" stroke="#231F20" strokeWidth="1.5" />
          <path d="M0,0 L-12,35 L12,35 Z" fill="#B3B792" stroke="#231F20" strokeWidth="1.5" strokeLinejoin="round" strokeLinecap="round" />
