                ...
                <h1 className="text-6xl font-bold tracking-tighter mt-4 font-playfair flex flex-col">
                    ...
                    <div className="relative inline-block my-4">
                        ...
                        >
                           ...
                           <path transform="translate(0, 10)" d="M0 15 Q 50 22, 100 15 T 200 15 T 300 15" stroke="currentColor" strokeWidth="15" fill="none" strokeLinecap="round" style={{filter: 'url(#wavy2)', opacity: 0.8}} />
